...
window.CANVAS_THEMES = [
  ...
  { key: 'phosphor',         label: 'Phosphor · green CRT (house theme)',     dark: true, hidden: true },
  { key: 'phosphor2',        label: 'Phosphor II · sage, disciplined',        dark: true, hidden: true },
  { key: 'studio-black',     label: 'Studio Black · cinematic black, quiet blue', dark: true, hidden: true },
  { key: 'blueprint',        label: 'Blueprint · drafting navy, thin strokes', dark: true, hidden: true },
  { key: 'blueprint-classic', label: 'Blueprint Classic · original preset',   dark: true, hidden: true },
  { key: 'contrast',         label: 'Contrast · black/white, one red',        dark: true, hidden: true },
  { key: 'paper',            label: 'Paper · ink on warm white (light)',      dark: false, hidden: true },
  { key: 'glass',            label: 'Glass · frosted panels',                 dark: true, hidden: true },
  { key: 'brutal',           label: 'Brutal · hard shadows',                  dark: false, hidden: true },
];
